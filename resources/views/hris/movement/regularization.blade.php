...
<ul class="nav nav-tabs">
    <li class="nav-item">
        <a class="nav-link transaction active" id="regularization" href="{{route('EMPMOVE')}}">Regularization</a>
    </li>
    <li class="nav-item">
...
@endif
<form action="{{route('regularize_employee')}}" method="POST">
<div class="row">
    <div class="col-sm-4 trx-panel" id="regularization">
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group">
                    <label for="effectivity">Regularization Date</label>
